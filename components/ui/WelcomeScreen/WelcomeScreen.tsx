...
export const WelcomeScreen = () => {
  ...
  useGSAP(() => {
    ...
    if (greetingElements && greetingElements.length > 0) {
        ...
        // Show each greeting with a smooth fade in/out and a gap between words
        const showDuration = 0.4;  // Duration the word is fully visible
        const fadeDuration = 0.15; // Smooth fade transition
        const gapDuration = 0.15;  // Blank gap between words
